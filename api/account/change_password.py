...
from helpers.translation import translate_dict_to_known
...
class ChangePassword(Resource):
    def __init__(self) -> None:
        ...
        self.patch_parser.add_arg("language")
    ...
    def patch(self) -> Response:
        ...
        if not email:
            return create_response(translate_dict_to_known(TOKEN_INVALID_RESPONSE, language, ["details"]))
