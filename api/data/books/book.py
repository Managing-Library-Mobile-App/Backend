...
class Book(Resource):
    def __init__(self) -> None:
        ...
        self.post_parser.add_arg("description", type=string_range_validation(max=150000))
        ...
        self.patch_parser.add_arg("description", type=string_range_validation(max=150000))
