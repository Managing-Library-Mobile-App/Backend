...
PASSWORD_CHANGED_RESPONSE: (dict[str, Any], int) = {
    "message": "password_changed",
    "details": "Password changed",
}, 200

PASSWORD_NOT_CHANGED_RESPONSE: (dict[str, Any], int) = {
    "message": "wrong_password",
    "details": "Wrong password",
}, 401
TOKEN_INVALID_RESPONSE: (dict[str, Any], int) = {
    "message": "token_invalid",
    "details": "Token invalid"
}, 401
TOKEN_VALID_RESPONSE: (dict[str, Any], int) = {
    "message": "token_valid",
    "details": "Token valid"
}, 200
CANNOT_DELETE_ADMIN_RESPONSE: (dict[str, Any], int) = {
    "message": "cannot_delete_admin",
    "details": "Admin account cannot be deleted",
}, 404

USER_DELETED_RESPONSE: (dict[str, Any], int) = {
    "message": "user_deleted",
    "details": "User deleted successfully",
}, 200

USER_DOES_NOT_EXIST_RESPONSE: (dict[str, Any], int) = {
    "message": "user_does_not_exist",
    "details": "User does not exist",
}, 404

WRONG_SECRET_RESPONSE: (dict[str, Any], int) = {
...
LOGGED_OUT_RESPONSE: (dict[str, Any], int) = {
    "message": "logged_out",
    "details": "Logged out"
}, 200

NOT_LOGGED_OUT_RESPONSE: (dict[str, Any], int) = {
    "message": "not_logged_out",
    "details": "Could not log out. User was not logged in."
}, 200

USER_NOT_LOGGED_IN_RESPONSE: (dict[str, Any], int) = {
    "message": "authentication_failed",
}, 401
LOCKED_USER_LOGIN_ATTEMPTS_RESPONSE: (dict[str, Any], int) = {
    "message": "locked_user_login_attempts",
    "details": "User locked because of too many unsuccessful attempts",
}, 401

EMAIL_WRONG_FORMAT_RESPONSE: (dict[str, Any], int) = {
...
USER_NOT_FOUND_RESPONSE: (dict[str, Any], int) = {
    "message": "user_not_found",
    "details": "User logged in with such token not found."
}, 401

USER_ALREADY_EXISTS_RESPONSE: (dict[str, Any], int) = {
    "message": "user_already_exists",
    "details": "User already exists",
}, 401

REGISTER_SUCCESSFUL_RESPONSE: (dict[str, Any], int) = {
    "message": "register_successful",
    "details": "Register successful",
}, 200
INSUFFICIENT_PERMISSIONS_RESPONSE: (dict[str, Any], int) = {
    "message": "insufficient_permissions",
    "details": "Insufficient permissions. Requires admin or access to the object",
}, 404

OBJECT_CREATED_RESPONSE: (dict[str, Any], int) = {
    "message": "object_created",
    "details": "Object created."
}, 200

OBJECT_DELETED_RESPONSE: (dict[str, Any], int) = {
    "message": "object_deleted",
    "details": "Object deleted."
}, 200

OBJECT_MODIFIED_RESPONSE: (dict[str, Any], int) = {
    "message": "object_modified",
    "details": "Object modified."
}, 200
# Args - directly in methods, fields that are calculated in the endpoints
# Kwargs - precalculated data that is here
